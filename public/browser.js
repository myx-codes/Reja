...
//     })
//     .catch((err) => {
//       console.log("Qaytadan urinib ko‘ring:", err);
//     });
// });
...
let creatField = document.getElementById("creat-field");

document
.getElementById("create-form")
.addEventListener("summit", function(e){
    e.preventDefault();
    
    axios.post("/create-item", {reja: new_reja})
    .post("/creat-item", {reja: creatField.value})
    .then((data) => {
